...
import SiteInformationModel from '../models/SiteInformation.js';
...
const prepareDatabase = async () => {
  ...
  const SiteInformation = sequelize.define(tables.SITE_INFORMATION, SiteInformationModel);
  ...
  databaseUtils().cacheModel(tables.SITE_INFORMATION, SiteInformation);
};
